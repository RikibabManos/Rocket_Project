...
def get_derivatives(t, state, mfr, dry_mass, fuel_mass_max, v_wind):
...
def RK4_new_state(t, state, dt, mfr, dry_mass, fuel_max, v_wind): 
    ...
    k1 = get_derivatives(t, state, mfr_adjusted, dry_mass, fuel_max, v_wind)
    k2 = get_derivatives( ( t + dt / 2 ) , ( state + ( (dt * k1) / 2) ), mfr_adjusted, dry_mass, fuel_max, v_wind )
    k3 = get_derivatives( ( t + dt / 2 ) , ( state + ( (dt * k2) / 2) ), mfr_adjusted, dry_mass, fuel_max, v_wind )
    k4 = get_derivatives( t + dt , ( state +  (dt * k3) ), mfr_adjusted, dry_mass, fuel_max, v_wind )
